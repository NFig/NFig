...
namespace NFig.Tests
{
    public class EncryptedSettingsTests
    {
        ...
        public void MultipleAttributes()
        {
            ...
            {
                Utils.CreateStore<MultipleAttributesSettings>(encryptor: new PassThroughEncryptor());
            });
        }
        ...
        public void NoTierDefaults()
        {
            Assert.Throws<NFigException>(() =>
            {
                Utils.CreateStore<NoTierDefaultsSettings>(encryptor: new PassThroughEncryptor());
            });
        }
        ...
        {
            var store = Utils.CreateStore<Settings>(encryptor: new PassThroughEncryptor());
        ...
        public void RsaEncryption()
        {
            ...
            var rsa = new RsaEncryptor(rcp, RSAEncryptionPadding.OaepSHA1);
