...
namespace NFig.Tests
{
    public class EncryptedSettingsTests
    {
        ...
        public void MultipleAttributes()
        {
            ...
            {
                new NFigMemoryStore<MultipleAttributesSettings, Tier, DataCenter>(APP_NAME, Tier.Local, DataCenter.Local, encryptor: new PassThroughEncryptor());
            });
        }
        ...
        public void NoTierDefaults()
        {
            Assert.Throws<NFigException>(() =>
            {
                new NFigMemoryStore<NoTierDefaultsSettings, Tier, DataCenter>(APP_NAME, Tier.Local, DataCenter.Local, encryptor: new PassThroughEncryptor());
            });
        }
        ...
        public void InvalidEncryptor()
        {
            Assert.Throws<NFigException>(() =>
            {
                new NFigMemoryStore<SettingsBase, Tier, DataCenter>(APP_NAME, Tier.Local, DataCenter.Local, encryptor: new InvalidSettingEncryptor());
            });
        }
        ...
        public void PassThroughEncryption()
        {
            ...
            var store = new NFigMemoryStore<Settings, Tier, DataCenter>(APP_NAME, Tier.Local, DataCenter.Local, encryptor: passThrough);
        ...
        public void RsaEncryption()
        {
            ...
            var store = new NFigMemoryStore<Settings, Tier, DataCenter>(APP_NAME, Tier.Prod, DataCenter.East, encryptor: rsa);
            var settings = store.GetAppSettings();
